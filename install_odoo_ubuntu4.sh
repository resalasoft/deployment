...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'RESALA' --group $OE_USER
...
sudo su root -c "printf 'logfile = /home/$OE_USER/${OE_USER}/${OE_CONFIG}.log\n' >> /home/$OE_USER/${OE_CONFIG}.conf"
...
User=$OE_USER
Group=$OE_USER
ExecStart=$OE_HOME_EXT/odoo-bin --config /home/$OE_USER/${OE_CONFIG}.conf  --logfile /home/${OE_USER}/${OE_CONFIG}.log
KillMode=mixed
